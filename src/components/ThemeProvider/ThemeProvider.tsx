...
import { classes, media } from '@/lib/style';
import { theme, tokens } from './theme';
import type { Theme, ThemeId, ThemeTokens } from './theme';
...
export const ThemeProvider = ({
  ...
  const currentTheme = { ...theme[themeId], ...themeOverrides } as Theme;
 ...
 */
export function createThemeProperties(theme: ThemeTokens) {
  return squish(
    Object.keys(theme)
 ...
 */
export function createThemeStyleObject(theme: ThemeTokens) {
