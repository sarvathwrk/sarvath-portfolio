...
const roles = ['SteerAuto Site', 'Buying and Selling Cars', 'Maintanance Works', 'Auction Cars'];
        ...
        <Fragment>
            ...
            <ProjectContainer className={styles.slice}>
                    ...
                    <ProjectSectionContent>
                        <ProjectTextRow>
                            ...
                            <ProjectSectionText>
                                ...
                                Our home page is a concise, user-friendly gateway to our website. It offers quick navigation, featuring essential information and services in a minimalist design. With a focus on simplicity, users can easily access key sections for a streamlined and efficient browsing experience.                            </ProjectSectionText>
                        </ProjectTextRow>
                        <ProjectImage
                    ...
                    <ProjectSectionContent>
                        <ProjectTextRow>
                            ...
                            <ProjectSectionText>
                                ...
                                Our "Used Car Listing" feature presents a curated collection of pre-owned vehicles, complete with essential details such as make, model, year, mileage, and pricing. Users can easily browse and compare listings with a straightforward, user-friendly interface, ensuring a seamless experience across devices.                                  </ProjectSectionText>
                        </ProjectTextRow>
                        <ProjectImage
                ...
                <ProjectSection>
                    <ProjectSectionColumns centered className={styles.columns}>
                        <div className={styles.imagesText}>
                            ...
                            <ProjectSectionText>
                                Our "Responsive Car Filter" offers users a seamless and adaptable way to refine their car search across all devices. Whether on a desktop or mobile, the filter provides a user-friendly experience, allowing easy customization based on criteria such as make, model, year, and price range.                            </ProjectSectionText>
                    ...
                    <ProjectSectionContent>
                        <ProjectTextRow>
                            ...
                            <ProjectSectionText>
                                ...
                                "Sell Cars" on our platform is a streamlined experience, guiding users through each step of the selling process with simplicity and security. The user-friendly interface ensures easy navigation and responsive design, making it accessible across various devices.                            </ProjectSectionText>
                        </ProjectTextRow>
                        <Image
                    ...
                    <ProjectSectionContent className={styles.grid}>
                        ...
                        <div className={styles.gridText}>
                            ...
                            <ProjectSectionText>
                                ...
                                Our "Testimonials" section highlights positive feedback from satisfied users, providing valuable insights into their experiences with our platform. It's a concise showcase of real-life success stories, emphasizing trust and credibility.                            </ProjectSectionText>
                        </div>
                    </ProjectSectionContent>
                </ProjectSection>
                <ProjectSection>
                    <ProjectSectionContent>
                        <ProjectTextRow>
                            ...
                            <ProjectSectionText>
                                "Contact Us" is your direct link to us. Accessible from the main menu, it offers essential contact information and a user-friendly interface, ensuring easy communication for inquiries or support.
                            </ProjectSectionText>
                        </ProjectTextRow>
                        <Image
                ...
                <ProjectSection light>
                    <ProjectSectionContent>
                        <ProjectTextRow>
                            <ProjectSectionHeading>Footer with Featured Car Listing</ProjectSectionHeading>
                            <ProjectSectionText>
                                Explore standout vehicles effortlessly with our footer's featured car listings. Seamlessly integrated, these curated selections offer a quick glimpse of noteworthy cars for an enhanced browsing experience.
                            </ProjectSectionText>
                        </ProjectTextRow>
                        <Image
