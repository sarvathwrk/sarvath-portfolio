...
const roles = ['Teawork Dashboard', 'Statistics and Reports', 'VAT & Discount Management', 'User Management'];
                ...
                <ProjectSection>
                    <ProjectSectionColumns centered className={styles.columns}>
                        <div className={styles.imagesText}>
                            <ProjectSectionHeading>Responsive Statistics and Reports</ProjectSectionHeading>
                            <ProjectSectionText>
                                List and describe the types of statistics charts included in the responsive design. This may include bar charts, line charts, pie charts, etc.
                            </ProjectSectionText>
                            <ProjectSectionText>
                    ...
                    <ProjectSectionContent>
                        <ProjectTextRow>
                            ...
                            <ProjectSectionText>
                                ...
                                Our "Tab Type Page Menus" offer an organized and intuitive interface, allowing users to navigate seamlessly between different sections. With a responsive design, this feature ensures a consistent and user-friendly experience on various devices.
                            </ProjectSectionText>
                        </ProjectTextRow>
                        <Image
                    ...
                    <ProjectSectionContent>
                        <ProjectTextRow>
                            ...
                            <ProjectSectionText>
                                ...
                                Our "Enquiry Management" system streamlines incoming inquiries, offering a user-friendly interface for efficient categorization, prioritization, and tracking. This ensures a prompt and organized approach to addressing and resolving user queries.
                            </ProjectSectionText>
                        </ProjectTextRow>
                        <Image
