...
const roles = ['Difuza Dashboard', 'Service provider', 'Dynamic Site Genarator', 'Super Admin Access'];
                ...
                <ProjectSection padding="top">
                    <ProjectSectionContent>
                        <ProjectTextRow>
                            ...
                            <ProjectSectionText>
                                Responsive Home Page with Logo,NavBar,Login Link,Slider,Social Media Links and Footer
                            </ProjectSectionText>
                        </ProjectTextRow>
                        <ProjectImage
                ...
                <ProjectSection >
                    <ProjectSectionContent>
                        <ProjectTextRow>
                            ...
                            <ProjectSectionText>
                                Identify the primary users or audience who will interact with the dashboard login page. This may include administrators, employees, or specific user roles with lots of Validation for Email,Username and Password and Alerts
                            </ProjectSectionText>
                        </ProjectTextRow>
                        <ProjectImage
                ...
                <ProjectSection>
                    <ProjectSectionColumns centered className={styles.columns}>
                        <div className={styles.imagesText}>
                            <ProjectSectionHeading>Responsive statistics Using Google looker Studio</ProjectSectionHeading>
                            <ProjectSectionText>
                                List and describe the types of statistics charts included in the responsive design. This may include bar charts, line charts, pie charts, etc.
                            </ProjectSectionText>
                            <ProjectSectionText>
                                Detail how the charts adapt to different screen sizes, resolutions, and orientations. Explain the responsive design principles implemented.
                            </ProjectSectionText>
                        </div>
                    ...
                    <ProjectSectionContent>
                        <ProjectTextRow>
                            ...
                            <ProjectSectionText>
                                ...
                                Our "Form with Datatable" seamlessly integrates a user-friendly form with a dynamic datatable, offering a cohesive experience for easy data entry, editing, and viewing. Enjoy the convenience of a responsive design that ensures optimal interaction on various devices.
                            </ProjectSectionText>
                        </ProjectTextRow>
                        <Image
                ...
                <ProjectSection padding="top">
                    <ProjectSectionContent className={styles.grid}>
                        ...
                        <div className={styles.gridText}>
                            ...
                            <ProjectSectionText>
                                Detail how data is presented in a tabular format, including rows and columns.<br />
                                Explain how users can sort data in ascending or descending order based on specific columns.<br />
                                Describe the filtering options available to users to narrow down the displayed data based on specific criteria.<br />
                                Explain how large datasets are divided into pages, and users can navigate through them.
                            </ProjectSectionText>
                        </div>
                    </ProjectSectionContent>
                </ProjectSection>
                <ProjectSection>
                    <ProjectSectionContent>
                        <ProjectTextRow>
                            ...
                            <ProjectSectionText>
                                The Forms module in our project facilitates user interaction by providing a structured way to collect and submit data. This document outlines the various form components, their usage, validation mechanisms, and best practices for implementing forms.
                            </ProjectSectionText>
                        </ProjectTextRow>
                        <Image
                ...
                <ProjectSection light>
                    <ProjectSectionContent>
                        <ProjectTextRow>
                            ...
                            <ProjectSectionText>
                                The Statistics and Reports module in our project enables the collection, processing, and analysis of data to derive meaningful insights. This document provides an overview of the processes involved in data collection, processing, analysis, and the generation of reports.
                            </ProjectSectionText>
                        </ProjectTextRow>
                        <Image
