...
import { cssProps, msToNum, numToMs } from '@/lib/style';
import styles from './Contact.module.css';

import { ProjectBackgroundContact, ProjectContainer } from '@/features/project';

import GalleryLarge3placeholder from '@/assets/volkihar-enderal-placeholder.jpg';

import { CustomAboutHeader } from '@/features/about/header/customHeader';
    ...
    <Fragment>
      ...
      <ProjectContainer>
        <ProjectBackgroundContact
          srcSet={[
            { src: '/images/contact/mxEloNi.jpg', width: 500 },
            { src: '/images/contact/mxEloNi.jpg', width: 500 },
          ]}
