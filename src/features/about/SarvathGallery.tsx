  ...
  return (
    <Fragment>
      ...
      <ProjectContainer>
        <ProjectBackground
          srcSet={[
            { src: '/images/about/GpQDsrG.png', width: 500 },
            { src: '/images/about/GpQDsrG.png', width: 700 },
          ]}
          ...
          <ProjectSectionContent>
            <ProjectTextRow center centerMobile noMargin>
              <div className="image-container">
                <img
                  src={`/file.png`}
                  // `placeholder` is not a valid attribute on a native <img> in
                  // React's DOM types. Kept to preserve the exact pre-existing
                  // JSX/runtime (a harmless no-op on a native <img>).
                  // @ts-expect-error non-standard <img> attribute retained intentionally
